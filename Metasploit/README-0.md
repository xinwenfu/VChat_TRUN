...
#### Option 1: Deploying the Attack with Armitage
...
Refer to [Penetration Testing](https://github.com/xinwenfu/GenCyber/blob/main/FieldTrips/V2/README.md#collecting-information-about-windows-vm) for deploying the Attack with Armitage.

#### Option 2: Deploying the Attack with Metasploit Console
